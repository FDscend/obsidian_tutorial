...
如果新建了 `section12/` 等目录，需要更新同步工作流的配置：
...
- name: Sync content
  run: |
    for dir in section0 section1 section2 section3 section4 section5 section6 section7 section8 section9 section10 section11 section12 appendix image; do
