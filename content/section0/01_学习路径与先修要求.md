...
| 8    | section8  | Quartz 静态部署   | 1–2 h     | section1  |
| 9    | section9  | Agent 基础        | 1 h       | section1  |
| 10   | section10 | Copilot 基础      | 2–3 h     | section9  |
| 11   | section11 | Copilot 实战案例  | 2–3 h     | section10 |
| 12   | section12 | Claude/Codex 接入 | 2–3 h     | section9  |

> 总预估耗时：**约 13–19 小时**（可在一周多内完成）。
...
### 路径 D：AI 进阶（Agent / Copilot 方向）

适合已有 Markdown 基础、想用 AI 提效的学员。

```
section0  →  section1  →  (section2 可选)  →  section9  →  section10  →  section11  →  section12
```

完成此路径后，你可以：

- 掌握 Agent 的接口知识并配置好 Python / Node.js / Git Bash / PowerShell 7 / rg 运行环境。
- 使用 Copilot 对话生成文档草稿。
- 编写自定义 prompt 和 instruction 文件。
- 接入 MCP 工具（如 Tavily 搜索）扩展 Copilot 能力。
- 在 VS Code 中接入 Claude Code / Codex，并配置代理与第三方网关。
